...
{
    // from: https://github.com/microsoft/referencesource/blob/master/System.Data.DataSetExtensions/System/Data/DataRowExtensions.cs
    /// <summary>
    ...
    public static class DataRowExtensions
    {
        ...
        private static class UnboxT<T>
        {
            ...
            private static T ValueField(object value)
            {
                ...
                {
                    throw DataSetUtil.InvalidCast(string.Format("Cannot cast DBNull.Value to type '{0}'. Please use a nullable type.", typeof(T)));
                }
                return (T)value;
            }
